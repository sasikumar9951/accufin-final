    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-2xl font-bold text-[#0a2236] mb-4">
            Your Financial Data, Structured for Accuracy and Insight
          </h2>

          <h3 className="text-xl font-bold text-[#0a2236] mt-6 mb-3">
          ...
          <ul className="list-none pl-0 space-y-2 text-[#008db3] mb-6">
            <li className="flex items-start">
              ...
              <span className="text-[#5a6a7a]">
                <b> Debits </b>(💰 Entering your business)
              </span>
            </li>
            <li className="flex items-start">
              <FaChevronRight className="mt-1 mr-2" />
              <span className="text-[#5a6a7a]">
                <b> Credits</b> (💸 Leaving your business)
              </span>
            </li>
          </ul>

          <p className="mb-4 text-[#5a6a7a] font-semibold">
          ...
          <ul className="list-none pl-0 space-y-2 text-[#008db3] mb-6">
            <li className="flex items-start">
              ...
              <span className="text-[#5a6a7a]">
                <b> Mathematical Accuracy </b>: Total Debits always equal Total
                Credits.
              </span>
            </li>
            <li className="flex items-start">
              <FaChevronRight className="mt-1 mr-2 text-green-500" />
              <span className="text-[#5a6a7a]">
                <b> Audit Trails </b>: Every dollar's path is traceable.
              </span>
            </li>
            <li className="flex items-start">
              <FaChevronRight className="mt-1 mr-2 text-green-500" />
              <span className="text-[#5a6a7a]">
                <b> Financial Integrity </b>: Prevents errors and fraud.
              </span>
            </li>
          </ul>
          ...
          <p className="mb-4 text-[#5a6a7a]">
            Spreadsheets work for startups—but when you scale, you need a
            structured foundation. A relational database organizes your finances
            like a digital ledger on steroids:
          </p>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b border-gray-200">
                  <td className="py-3 px-4 text-[#5a6a7a]">
                    Manual data entry
                  </td>
                  <td className="py-3 px-4 text-[#5a6a7a]">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden my-8 border border-gray-200">
            <div className="bg-[#0a2236] p-4">
              ...
              <p className="text-[#00c6fb]">
                Our system enforces double-entry logic through carefully
                designed tables:
              </p>
            </div>
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <div className="bg-[#00c6fb] text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                    1
                  </div>
                  <h4 className="text-lg font-semibold text-[#0a2236]">
                    Accounts Table
                  </h4>
                </div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full bg-gray-50 rounded-lg overflow-hidden">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="px-4 py-3 text-[#0a2236] font-mono">
                          101
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="px-4 py-3 text-[#0a2236]">
                          Sales Revenue
                        </td>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden my-8 border border-gray-200">
            <div className="bg-gradient-to-r from-[#008db3] to-[#0a2236] p-6">
              ...
              <p className="text-[#00c6fb] mt-2">
                Transform your financial management with our robust accounting
                system
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
              ...
              <div className="bg-[#f8fafc] p-5 rounded-lg border border-gray-100 hover:shadow-md transition-all">
                <div className="flex items-start">
                  <div className="bg-[#00c6fb] text-white rounded-full w-8 h-8 flex items-center justify-center mr-4 flex-shrink-0">
                    1
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-[#0a2236] mb-2">
                      Error-Proof Bookkeeping
                    </h4>
                    <p className="text-[#5a6a7a]">
                      No more unbalanced spreadsheets. The system rejects
                      entries that break accounting rules.
                    </p>
                    <div className="mt-3 flex items-center">
                      <FaCheck className="text-green-500 mr-2" />
                      <span className="text-sm text-[#0a2236]">
              ...
              <div className="bg-[#f8fafc] p-5 rounded-lg border border-gray-100 hover:shadow-md transition-all">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[#5a6a7a]">
                      Every change is tracked. Reconstruct financial history
                      with SQL queries.
                    </p>
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex items-center space-x-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-[#00c6fb]">
                          10
                        </div>
            ...
            <div className="bg-[#f0f9ff] border-t border-gray-200 p-6 text-center">
              <p className="text-[#0a2236] font-medium">
                ...
                <a
                  href="/contact"
                  className="text-[#00c6fb] hover:underline font-semibold"
                >
                  Contact us today →
                </a>
              </p>
          ...
          <div className="my-12 space-y-8">
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-[#0a2236] mb-4">
                ...
                <span className="text-[#00c6fb]">(We Promise!)</span>
              </h2>
              <p className="text-xl text-[#5a6a7a] max-w-3xl mx-auto">
                Think of accounting as telling the story of your business in
                numbers.
              </p>
            </div>
            ...
            <p className="text-center text-[#5a6a7a] text-lg mt-6 max-w-2xl mx-auto">
              You don't need an accounting degree. You just need a system that
              makes sense.
            </p>
                ...
                <table className="min-w-full border-collapse">
                  <thead>
                    <tr className="border-b-2 border-[#00c6fb]">
                      <th className="text-left py-4 px-4 text-[#0a2236] font-semibold">
                        Concept
                      </th>
                      <th className="text-left py-4 px-4 text-[#0a2236] font-semibold">
                        What It Means
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr>
                      <td className="py-4 px-4 font-medium text-[#0a2236]">
                        Revenue
                      </td>
                      <td className="py-4 px-4 text-[#5a6a7a]">
                        Money coming in from sales/services
                      </td>
                      <td className="py-4 px-4 text-[#5a6a7a] italic">
                        "Am I attracting enough customers?"
                      </td>
                    </tr>
                    <tr>
                      <td className="py-4 px-4 font-medium text-[#0a2236]">
                      ...
                      <td className="py-4 px-4 text-[#5a6a7a]">
                        Money going out (rent, supplies, payroll, etc.)
                      </td>
                      <td className="py-4 px-4 text-[#5a6a7a] italic">
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-4 text-[#5a6a7a]">
                        Revenue – Expenses (what's left for YOU)
                      </td>
                      <td className="py-4 px-4 text-[#5a6a7a] italic">
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-4 text-[#5a6a7a]">
                        Timing of money in/out (e.g., invoices paid late = empty
                        bank account)
                      </td>
                      <td className="py-4 px-4 text-[#5a6a7a] italic">
                        "Can I pay bills this month?"
                      </td>
                    </tr>
                    <tr>
                      <td className="py-4 px-4 font-medium text-[#0a2236]">
                      ...
                      <td className="py-4 px-4 text-[#5a6a7a]">
                        What you OWN (cash, equipment, inventory)
                      </td>
                      <td className="py-4 px-4 text-[#5a6a7a] italic">
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-4 text-[#5a6a7a]">
                        What you OWE (loans, unpaid bills)
                      </td>
                      <td className="py-4 px-4 text-[#5a6a7a] italic">
          ...
          <div className="py-12 px-4 bg-gradient-to-br from-[#f8fafc] to-[#d5e5f7]">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-bold text-[#0a2236] mb-4">
                  Why Most{" "}
                  <span className="text-[#00c6fb]">Non-Accountants</span>{" "}
                  Struggle
                </h2>
              ...
              <div className="mt-12 text-center bg-white p-6 rounded-xl shadow-sm max-w-2xl mx-auto">
                ...
                <p className="text-[#5a6a7a] mb-4">
                  Our experts handle the numbers so you can focus on what you do
                  best
                </p>
                <a
                  href="/contact"
          ...
          >
            <div className="max-w-6xl mx-auto space-y-12">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-[#0a2236] mb-4">
                  How We Make Accounting{" "}
                  <span className="text-[#00c6fb]">Painless</span> For You
                </h2>
                <blockquote className="text-xl italic text-[#5a6a7a] max-w-2xl mx-auto">
                  "We translate 'accounting-speak' into plain English and
                  actionable insights."
                </blockquote>
              </motion.div>
              ...
              >
                ...
                >
                  A rigorous framework for measuring progress when traditional
                  financial metrics fail.
                </motion.p>
              ...
              >
                ...
                >
                  <table className="min-w-full border-collapse">
                    <thead>
                      <tr className="border-b-2 border-[#00c6fb]">
                        <th className="py-4 px-4 text-left text-[#0a2236] font-semibold">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        [
                          "Fixed KPIs (Revenue, Expenses)",
                          "Adaptive Metrics (Engagement, Conversion, Retention)",
                        ],
                        ...
                        >
                          ...
                          <td className="py-4 px-4 text-[#0a2236] font-medium">
                            {innovation}
                          </td>
                        </motion.tr>
                      ))}
              ...
              >
                ...
                >
                  Tracking page views, total users, or gross revenue feels safe
                  – but it's dangerously misleading.
                </motion.p>
                      ...
                      <ul className="space-y-3">
                        {stage.items.map((item) => (
                          ...
                          >
                            ...
                            <span
                              className={`${item.startsWith('"') ? "italic text-[#5a6a7a]" : "text-[#0a2236]"}`}
                            >
                              {item}
                            </span>
                          </motion.li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs mt-1">
                        {formatTextWithLinks(b.content, "white")}
                      </div>
