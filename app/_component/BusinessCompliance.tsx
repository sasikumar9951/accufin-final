...
export default function BusinessCompliances() {
    ...
    return (
        <section
            ...
            style={{
                backgroundImage: "url('/business-compliance.jpg')", // Compliance-specific image
        ...
        >
            ...
            >
                ...
                <div className="flex items-center space-x-2 text-lg">
                    ...
                    <span className="text-white">/</span>
                    <span className="text-white">Business Compliance</span>
                </div>
            </motion.div>
        </section>
    );
